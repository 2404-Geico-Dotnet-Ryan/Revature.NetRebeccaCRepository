    ...
    public int Driver.Id { get; set; } //which user got the ticket
    ...
    public Ticket (int ticketId, string type, decimal cost, decimal balance, bool paidinfull, long duedate, string driver)
    {
        TicketId = ticketId;
        Type = type;
        Cost = cost;
