...
class MovieStorage
{
   ...
   */ 
    ...
    {
        Movie movie1 =new(1,"Iron Man",5, true, 0);
        Movie movie2 =new(2,"The Avengers",4.50, true, 0);
        Movie movie3 =new(3,"Winter Solidier",3.99, true, 0);
        Movie movie4 =new(4,"AntMan",4.25, true, 0);
        //introducing automatic way to keep up with ID **this is when line 15 in code was introduced we hard coded before that
        Movie movie5 =new (idCounter,"Xmen", 5.00, true,0); idCounter++; //this is post incremented to increase idCounter for next movie
        //now need to add to the dictionary 
        Movie movie6 =new (idCounter,"Wolverine", 5.99, true,0); idCounter++; 
